...
namespace PixelCrushers.DialogueSystem {
	...
	public class Selector : MonoBehaviour {
		...
		protected virtual void Run2DRaycast() {
			...
			var ray = mainCamera.ScreenPointToRay(GetSelectionPoint());
			...
			if(raycastAll) {
				...
				int numHits = Physics2D.GetRayIntersectionNonAlloc(
					ray, lastHits2D, maxSelectionDistance, layerMask
				);
				...
				RaycastHit2D hit;
				hit = Physics2D.GetRayIntersection(ray, maxSelectionDistance, layerMask);
